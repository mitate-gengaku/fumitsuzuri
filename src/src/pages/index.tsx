...
const Home = () => {
  ...
  const { book, form, setBook } = useCreateBook();
  ...
  return (
    <main className="flex h-screen w-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
      <div className="relative flex h-full w-full p-4">
        ...
        {!show && !url && !burl && file && (
          <Form {...form}>
            <form className="relative mx-auto flex h-full w-fit">
              <div
                className={cn(
              ...
              >
                ...
                >
                  <FormField
                    ...
                    render={({ field }) => (
                      <div className="h-[calc(670px-5rem)] cursor-pointer">
                        <textarea
                          {...field}
                          className={cn(
        ...
        {!show && url && (
          <img src={url} alt="画像" className="h-64 object-cover" />
        )}
        {!show && burl && (
          <img src={burl} alt="画像" className="h-64 object-cover" />
        )}
        <UploadFileForm />
        <ZoomCustomizer />
      </div>
